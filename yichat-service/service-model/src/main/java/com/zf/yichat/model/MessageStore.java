...
public class MessageStore implements Serializable {
    ...
    public MessageStore(Long id, Long userId, Integer referType, Long referId, Long time, Integer status, String messageId, Date ctime, String content, String text) {
        this.id = id;
        this.userId = userId;
